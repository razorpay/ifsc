...
The scraper applies the above rules automatically when generating `data/banknames.json` (e.g. strips leading "The", trailing "Ltd"/"Limited", normalises "Co-operative" and "Sahakari"). Copy that file to `src/banknames.json` and edit further as needed.
